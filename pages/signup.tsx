...
const Signup: NextPage = () => {
    ...
    return (
        <div
            className='font-medium bg-[url("/logo-bg.jpeg")] bg-cover bg-center bg-no-repeat h-screen flex items-center'>
                ...
                <Space direction="vertical" size="middle" style={{display: 'flex'}}>
                    <div className="my-2 flex flex-col gap-2">
                        ...
                        <div className="flex justify-center gap-1 font-medium text-gray-500">
                            Bạn đã có tài khoản?
                            <a className='float-right' onClick={() => router.push('/login')}>Đăng nhập</a>
                        </div>
                    </div>
