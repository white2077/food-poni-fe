      ...
      <div className="d-flex align-items-center flex-shrink-0 me-5">
        ...
        <div className="symbol-group symbol-hover flex-shrink-0 me-2">
          ...
          <div className="symbol symbol-circle symbol-35px">
            <div className="symbol-label fw-bold bg-warning text-inverse-warning">
              A
            </div>
          </div>
          {/* end::User */}
          ...
          {/* begin::User */}
          <div className="symbol symbol-circle symbol-35px">
            <div className="symbol-label fw-bold bg-primary text-inverse-primary">
              S
            </div>
          </div>
          {/* end::User */}
          ...
          {/* begin::User */}
          <div className="symbol symbol-circle symbol-35px">
            <div className="symbol-label fw-bold bg-danger text-inverse-danger">
              P
            </div>
          </div>
          {/* end::User */}
