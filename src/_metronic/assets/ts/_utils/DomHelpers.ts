...
function getHighestZindex(el: HTMLElement) {
  ...
  while (bufferNode && bufferNode !== document) {
    // Ignore z-index.d.ts if position is set to a value where z-index.d.ts is ignored by the browser
    ...
    if (
      ...
      // <div style="z-index.d.ts: -10;"><div style="z-index.d.ts: 0;"></div></div>
