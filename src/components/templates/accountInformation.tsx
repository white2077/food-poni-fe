          ...
          {isLoading ? (
            ...
            <div className="bg-white p-3 rounded-lg grid lg:grid-cols-5 grid-cols-1 gap-4">
              <div className="col-span-3">
                <div className="mb-3 text-[15px] text-gray-500 font-sans">
                  Thông tin cá nhân
                </div>
                  ...
                  <div className="col-span-1">
                    <div className="flex flex-col items-center mr-5 gap-5 relative">
                      <Dropdown menu={{ items }} placement="bottom" arrow>
                        <button className="absolute z-50 bg-gray-400 w-5 h-5 flex justify-center items-center rounded-full bottom-2 right-2">
                          <img className="w-3 h-3" src="/pen.png" />
                        </button>
                      </Dropdown>
                      <Image
                        preview={false}
                ...
                <div className="mt-8 text-center">
                  <Button className="w-44 !bg-primary !text-white hover:!bg-white hover:!text-[#F36F24]">
                    Lưu thay đổi
                  </Button>
                </div>
              </div>
