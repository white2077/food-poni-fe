...
const AudioPlayer = () => {
  ...
  const songTitles = [
    "#1 Đợi 52Hz",
    "#2 Ánh sao và bầu trời ",
    "#3 ĐỪNG LÀM TRÁI TIM ANH ĐAU",
    "#4 Khiem - Yên Bình Có Quá Đắt Không",
    "#5 Giấc Mơ Của Em (Suy Ver.)",
  ];
  ...
  return (
    <div
      ...
      className="bg-gray-300 max-w-[300px] rounded-lg border-2 border-orange-500"
    >
      <div className="text-ellipsis flex justify-center">
