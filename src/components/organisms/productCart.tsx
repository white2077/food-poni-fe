...
export default function ProductCart({id, price, thumbnail, productName, productDetailName, status}: {
    id: string,
    price: number,
    thumbnail: string,
    productName: string,
    ...
    const {page, isCreateLoading} = useSelector((state: RootState) => state.cart);

    const isExisted: boolean = page.content.some(item => item.productDetail.id === id);
                ...
                </div>
                {
                    status ? (
                        <Flex vertical gap='small' className="w-full">
                            ...
                            <Button block onClick={() => dispatch(createCartRequest({
                                quantity: quantity,
                                productDetail: id,
                                productName: productName,
                                productDetailName: productDetailName,
