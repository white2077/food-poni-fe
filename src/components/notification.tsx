...
import {getNotificationsPageByCustomer} from "@/api/notification.query";
...
import {markIsReadNotification, setNotifications} from "@/redux/notification.ts";
                                                                ...
                                                                <div key={index}
                                                                     onClick={() => {
                                                                         if (!notification.read) {
                                                                             ...
                                                                             apiWithToken().patch("/notifications/update-read", {
                                                                                 id: notification.id,
                                                                                 read: true
                                                                             }, {
                                                                                 headers: {
                                                                    ...
                                                                    <div className="flex flex-col gap-3.5">
                                                                        <div className="flex flex-col gap-1">
                                                                            ...
                                                                            <span
                                                                                className="flex items-center text-2xs font-medium text-gray-500">
                                                                                {(() => {
