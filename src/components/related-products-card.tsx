...
import { IProductCard } from "./productRowsFilter.tsx";
...
const ProductCardRelated = ({ product }: { product: IProductCard }) => {
  const currentUser: CurrentUser = useSelector(
    (state: RootState) => state.user.currentUser,
  );

  const shippingAddress: AddressAPIResponse = useSelector(
    (state: RootState) => state.address.shippingAddress,
  );

  const selectedAddress = useSelector(
    (state: RootState) => state.searchPosition.searchPosition,
  );
